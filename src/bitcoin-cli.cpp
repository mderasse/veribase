...
static void SetupCliArgs()
{
    ...
    gArgs.AddArg("-rpcport=<port>", strprintf("Connect to JSON-RPC on <port> (vericoin: %u, verium: %u)", vericoinBaseParams->RPCPort(), veriumBaseParams->RPCPort()), ArgsManager::ALLOW_ANY | ArgsManager::NETWORK_ONLY, OptionsCategory::OPTIONS);

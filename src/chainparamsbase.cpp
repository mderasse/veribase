...
void SetupChainParamsBaseOptions()
{
    ...
    gArgs.AddArg("-vericoin", "Use Vericoin chain. Equivalent to -chain=vericoin.", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::CHAINPARAMS);
    gArgs.AddArg("-verium", "Use Verium chain. Equivalent to -chain=verium.", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::CHAINPARAMS);
}
